                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($row = $stmt->fetch()) { ?>
                                                <tr>
                                                    <td><a href="javascript:void(0)" class="font-bold link"><?= $row["idm"] ?></a></td>
                                                    <td><a href="javascript:void(0)" class="font-weight-medium link"><?= $row["name"] ?></a></td>
                                                    <td><?= $row["score"] ?></td>
                                                    <td><?= $row["status"] ?></td>
                                                    <td><?= $row["type"] ?></td>
                                                    <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; Width: 1px;"  ><?= $row["comment"] ?></td>
                                                    <td><?= $row["recom"] ?></td>
                                                    <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; Width: 1px;" ><?= $row["linkweb"] ?></td>
                                                    <td><?= $row["contry"] ?></td>
