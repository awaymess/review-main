            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <form action="insartproduct1.php" method="post" enctype="multipart/form data">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="score" value="1">
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="status" value="ดูแล้ว">
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="type" value="movie">
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="recom" value="good">
                                                    ...
                                                    <td>
                                                        <input class="form-control" name="linkweb" type="text">
                                                    </td>
                                                    <td>
                                                        <select class="form-control" name="contry" value="Korea">
